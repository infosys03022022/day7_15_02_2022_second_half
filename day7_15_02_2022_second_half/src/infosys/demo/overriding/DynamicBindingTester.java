package infosys.demo.overriding;
public class DynamicBindingTester {
	...
	public static void displayEmployeeDetails(Educator educator) {
		educator.displayDetails();	// displayDetails invoked will be based on the object received
	}
	public static void displayEmployeeDetails(Manager manager) {
		manager.displayDetails();	// displayDetails invoked will be based on the object received
	}
}

class Employee {
	protected String name = "James Anthony";
